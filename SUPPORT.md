...
2. If the one-time Pro unlock is missing after reinstalling, open **Profile** and choose **Restore purchases**.
...
The one-time MasterMechanic Pro purchase is processed by Apple. It is a non-consumable unlock with no recurring charge. MasterMechanic includes a **Restore purchases** control in the Profile screen so the unlock can be restored on supported devices using the same Apple ID.
